...
/* const investmentData: InvestmentYearData[] = [
 ...
 function formSubmissionHandler(event){
  ...
  // Next step is to use data from the form fields and calculate the investment data 
  ...
  for (let i = 0; i < duration; i ++){
    ...
    let totalInvestmentValue = valueBeforeAnnualContribution + annualReturn + annualContribution;
     ...
     valueBeforeAnnualContribution = totalInvestmentValue + annualContribution;
  ...
  return (
    <div>
      <h2>Ex95InvestmentCalculator</h2>
      <form onSubmit={ formSubmissionHandler }>
        <div>Initial Investment: <input type="number" name="initialInvestment" /></div>
        <div>Annual return rate: <input type="number" name="returnRate"/></div>
        <div>Investment duration(years): <input type="number" name="duration" /></div>
        <div>Additional annual contribution: <input type="number" name="annualContribution" /></div>
